...
class Registro:
    ...
    def getLabels(self):
        Label(self.frame, text='Codigo:',foreground="#333333", border=1,bg="#FFE5B4",font=("Courier", 8, "italic")).place(x=450, y=10)
        Label(self.frame, text='Nombre: ',foreground="#333333",border=1,bg="#FFE5B4",font=("Courier", 8, "italic")).place(x=450, y=30)
        Label(self.frame, text='Autor: ',foreground="#333333",border=1,bg="#FFE5B4",font=("Courier", 8, "italic")).place(x=450, y=50)
        Label(self.frame, text='Precio: ',foreground="#333333",border=1,bg="#FFE5B4",font=("Courier", 8, "italic")).place(x=450, y=70)
        Label(self.frame, text='Categoria:',foreground="#333333",border=1,bg="#FFE5B4",font=("Courier", 8, "italic")).place(x=450, y=90)
    ...
    def getButtons(self):
        style = ttk.Style()
        Button(self.frame, text='Guardar libro', command=self.add_libro,bg="#87CEEB",fg="black", width=163).place(x=0, y=133)
        Button(self.frame, text="Eliminar", bg="#FFFACD",fg="black",command=self.eliminar_libro, width=79).place(x=0, y=382)
        Button(self.frame, text="Editar",bg="#E6E6FA",fg="black",command=self.editar_libro, width=79).place(x=500, y=382)

        Button(self.frame,text="Buscar",command=self.buscar_libro,bg="#FFE5B4",fg="black", bd=0).place(x=275,y=50)
        Button(self.frame,text="Limpiar",command=self.reset_search,bg="#FFE5B4",fg="black", bd=0).place(x=323,y=50)
